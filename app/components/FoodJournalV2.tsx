...
const DEFAULT_CUISINES = ["Americana", "Argentina", "Buffet", "China", "Colombiana", "Coreana", "Desayuno", "Española", "Francesa", "Griega", "India", "Italiana", "Japonesa", "Libanesa", "Mediterránea", "Merienda", "Mexicana", "Otra", "Peruana", "Poke", "Tailandesa", "Tapitas", "Turca", "Vegetariana"];
